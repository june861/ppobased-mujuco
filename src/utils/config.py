...
def add_fixed_arguments(parser, args = None):
    ...
    parser.add_argument('--algo', type=str, default=args.algo if args != None else None, help="Which algorithm to test", choices=["appo","ppo-clip", "ppo-penalty"])
...
def get_conf():
    ...
    args.exp_name = f'{args.env_id}_{args.algo}_update{args.update_epochs}_clipcoef{args.clip_coef}_sample{args.sample_action_num}_{args.decay_delta}_v2'
    # else:
